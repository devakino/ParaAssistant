            ...
            <div className="flex flex-col space-y-4 text-sm text-gray-700">
                ...
                {searchInfo.stages.includes('searching') && (
                    <div className="relative">
                        {/* Green dot */}
                        <div className="absolute -left-3 top-1 w-2.5 h-2.5 bg-gray-400 rounded-full z-10 shadow-sm"></div>

                        {/* Connecting line to next item if reading exists */}
                        {searchInfo.stages.includes('reading') && (
                            <div className="absolute -left-[7px] top-3 w-0.5 h-[calc(100%+1rem)] bg-gradient-to-b from-gray-500 to-gray-500"></div>
                        )}
                        ...
                        <div className="flex flex-col max-w-md">
                            ...
                            <div
                                className={`rounded-lg py-3 px-5 ${message.isUser
                                    ? 'bg-gradient-to-br from-[#111122] to-[#111122] text-white rounded-br-none shadow-md'
                                    : 'bg-[#ccddee] text-gray-800 border border-gray-200 rounded-bl-none shadow-sm'
                                    }`}
                            >
                                {message.isLoading ? (
